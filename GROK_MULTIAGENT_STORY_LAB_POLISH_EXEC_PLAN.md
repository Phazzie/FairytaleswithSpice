...
- [x] Repair three blind spots in the deterministic story-quality scan the Phase 6 evals read (PR #293). The scan is what this plan's "judged by evidence instead of vibes" rests on, so what it cannot see is what no eval can report:
