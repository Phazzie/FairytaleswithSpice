...
- Deterministic story-quality report evidence:
  ...
  - `tests/story-quality-evals.test.ts` now fails unless the report includes all seven planned dimensions, normalized 0-100 scores, explainable signals, the prose-quality specificity and sensory-texture signals, and the audio-readiness speaker-variety signal.
