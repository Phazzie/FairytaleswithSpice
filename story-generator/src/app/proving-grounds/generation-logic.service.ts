...
import { CreatureType } from '../contracts';
...
export class GenerationLogicService {
  ...
  getAllAuthorStyles(creature: CreatureType): AuthorStyle[] {
    switch (creature) {
      case 'vampire':
  ...
  selectRandomAuthors(creature: CreatureType): AuthorStyle[] {
  ...
  generateRandomLogic(creature: CreatureType): GenerationLogic {
    return {
