...
None of the five were merged or closed this cycle, for the same reasons as the last two cycles: #325 crosses the account/auth boundary, #327 and #322 are multi-package/major-version dependency bundles, #316 and #198 both carry open questions this routine defers to a human. Per this routine's own instructions, a status comment is not repeated on a PR already commented on in a prior cycle unless something material changed — nothing did, on any of the five, so no comments were posted this cycle.
