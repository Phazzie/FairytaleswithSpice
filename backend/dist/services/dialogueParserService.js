...
exports.DialogueParserService = void 0;
class DialogueParserService {
     ...
     */
    assignCharacterVoices(segments, storyCreature) {
     ...
     */
    parseNarrativeAndDialogue(content) {
        const result = [];
     ...
     */
    analyzeCharacters(segments, storyCreature) {
     ...
     */
    determineCharacterVoice(speaker, analysis, storyCreature) {
        const lowerSpeaker = speaker.toLowerCase();
        ...
        const isFemale = femaleIndicators.some(indicator => lowerSpeaker.includes(indicator) || lowerTextSample.includes(indicator));
        const isMale = maleIndicators.some(indicator => lowerSpeaker.includes(indicator) || lowerTextSample.includes(indicator));
     ...
     */
    determineCreatureContext(speaker, analysis, storyCreature) {
        const lowerSpeaker = speaker.toLowerCase();
        const lowerTextSample = analysis.textSample.toLowerCase();
...
exports.DialogueParserService = DialogueParserService;
