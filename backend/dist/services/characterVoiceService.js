...
exports.CharacterVoiceService = void 0;
class CharacterVoiceService {
     ...
     */
    createCharacterProfiles(characterNames, storyCreature) {
        const profiles = [];
     ...
     */
    getVoiceSettings(voiceType, emotionalTone) {
     ...
     */
    assignVoiceType(name, storyCreature) {
     ...
     */
    determineCreatureType(name, voiceType, storyCreature) {
        if (voiceType.includes('vampire'))
            return 'vampire';
        if (voiceType.includes('werewolf'))
            return 'werewolf';
        if (voiceType.includes('fairy'))
            return 'fairy';
     ...
     */
    getDefaultVoiceSettings(voiceType) {
        const baseSettings = {
            stability: 0.5,
     ...
     */
    getAvailableVoicesForCreature(creature) {
        const baseVoices = ['human_male', 'human_female', 'narrator'];
        switch (creature) {
            case 'vampire':
...
exports.CharacterVoiceService = CharacterVoiceService;
