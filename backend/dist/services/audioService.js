...
const dialogueParsingService_1 = require("./dialogueParsingService");
class AudioService {
    constructor() {
        this.elevenLabsApiUrl = 'https://api.elevenlabs.io/v1';
        this.elevenLabsApiKey = process.env.ELEVENLABS_API_KEY;
        this.dialogueParser = new dialogueParsingService_1.DialogueParsingService();
     ...
     */
    getVoiceIdForCharacter(characterType) {
     ...
     */
    getVoiceSettingsForEmotion(emotion, characterType) {
        const baseSettings = {
            stability: 0.5,
            similarity_boost: 0.8,
            style: 0.5,
     ...
     */
    async uploadSegmentToStorage(audioData, segment, input) {
     ...
     */
    async stitchAudioSegments(segments, input) {
