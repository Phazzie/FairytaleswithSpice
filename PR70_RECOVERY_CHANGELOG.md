...
- The service tests are driven through each service's own earliest refusal — input validation — so no counterfactual and no assertion here spends a provider call.
