...
- Validation run: `npm run test:all` exits 0 (58 suites); `cd story-generator && npx tsc --noEmit` is clean and `npm run build` succeeds. The four counterfactuals above were run and reverted, and none is committed.
